...
class MenuViewTest(TestCase):
    def setup(self):
        Menu.objects.create(title="Ice", price=1, inventory=1)
        Menu.objects.create(title="Peas", price=2, inventory=2)
        Menu.objects.create(title="Bread", price=3, inventory=3)
        Menu.objects.create(title="Soup", price=4, inventory=4)
        Menu.objects.create(title="honey", price=5, inventory=5)
